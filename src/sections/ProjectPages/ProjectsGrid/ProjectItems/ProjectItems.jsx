              ...
              <div className="item_sorting_list">
                ...
                <button>
                  ...
                  <ul className="sub-menu">
                    ...
                    <li><img src={coinIcon2} alt="icon" /> Ethereum (ETH) Coming Soon</li>
                    <li><img src={coinIcon3} alt="icon" /> Polygon Coming Soon</li>
                    <li><img src={coinIcon3} alt="icon" /> Venom Coming Soon</li>
                    <li><img src={coinIcon4} alt="icon" /> All Blockchains</li>
                  </ul>
                </button>
              </div>
            </TabList>
